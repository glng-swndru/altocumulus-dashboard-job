    ...
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
        <div className="col-span-2 space-y-10">
          <div>
            <div className="tex-3xl font-semibold">Description</div>
            <div className="text-gray-500 mt-3">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam
                recusandae, temporibus quae repellendus earum aspernatur vero
                saepe rerum ipsum itaque sed. Voluptatem impedit accusantium
                sed, animi iusto ipsam repellendus assumenda?
              </p>
            </div>
          </div>
          <div>
            <div className="tex-3xl font-semibold">Responsibilities</div>
            <div className="text-gray-500 mt-3">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam
                recusandae, temporibus quae repellendus earum aspernatur vero
          ...
          <div>
            <div className="tex-3xl font-semibold">Who You Are</div>
            <div className="text-gray-500 mt-3">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam
                recusandae, temporibus quae repellendus earum aspernatur vero
          ...
          <div>
            <div className="tex-3xl font-semibold">Nice-To-Haves</div>
            <div className="text-gray-500 mt-3">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam
                recusandae, temporibus quae repellendus earum aspernatur vero
        ...
        <div>
          ...
          <div className="mb-10 space-y-5">
            <div className="flex justify-between">
              ...
              <div className="font-semibold">31 Jul 2024</div>
            </div>
            <div className="flex justify-between">
              <div className="text-gray-500">Job Posted On </div>
              <div className="font-semibold">01 Jul 2024</div>
            </div>
            <div className="flex justify-between">
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          {[0, 1, 2].map((item: number) => (
            <div key={item}>
              ...
              <div className="text-lg font-semibold mb-3">Full Healtcare</div>
              <div className="text-gray-500">
